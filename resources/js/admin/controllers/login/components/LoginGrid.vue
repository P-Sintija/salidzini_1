<template>
        ...
        <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            ...
            <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                <div class="px-5 py-7">
                    ...
                    <input type="text" class="border border-gray-200 rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
    ...
    <forgot-password v-model="forgotPassword"></forgot-password>
...
export default {
    ...
    methods: {
        isPasswordReEnteredCorrect() {
            if (this.userData.password === this.userData.reEnteredPassword) {
                this.errorMessage = '';
                return true;
            }
            this.errorMessage = 'Please enter a password again!';
            return false;
        },

        submit() {
            if(this.isPasswordReEnteredCorrect()) {
